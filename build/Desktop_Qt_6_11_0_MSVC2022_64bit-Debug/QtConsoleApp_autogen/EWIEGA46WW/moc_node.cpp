...
template <> constexpr inline auto Node::qt_create_metaobjectdata<qt_meta_tag_ZN4NodeE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(Data)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'set_value'
        QtMocHelpers::SlotData<void(Data)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Node::*)(Data )>(_a, &Node::value_changed, 0))
            return;
    }
}
...
// SIGNAL 0
void Node::value_changed(Data _t1)
{
